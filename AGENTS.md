...
| Body kit (player, drone, weapon, cover) | `lib/body/` vendored to `src/body/` — verify `body_kit` |
| Engine law (vanilla Vite metres Y-up) | `lib/craft/engine.js` — verify `engine_law` |
