...
// ──────────────────────────────────────────────────────────────────────
//
// Companion to `pixelart.js` (static draw vocab) and `effects.js`
...
import { lightningBolt, LIGHTNING_ARC } from './pixelart.js';
...
// Reuses `lightningBolt` from pixelart.js so palettes work identically.
//
//   opts:
