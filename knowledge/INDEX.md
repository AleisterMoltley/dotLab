...
Turbo (`bin/turbo.py`) injects a **subset** by keyword. Keep packs dense; first 2k chars matter most.

| File | When |
|------|------|
| `identity.md` | Always (core) — **you are Grok** as dotLab |
| `grok-kernel.md` | Always (core) — pairing is `bin/grok.py`, HOST SESSION is locked, traces → LoRA |
...
| `threejs-advanced.md` | three / lighting / mixer |
| `threejs-ecosystem.md` | libs, R3F only if React |
...
| `live/pixel-api.md` | compact pixel/Canvas crib (live-docs) |
